...
export const MERCHANT_CATEGORIES: Record<string, MerchantInfo> = {
  ...
  'hema': { categorie: 'Eten & Drinken', subcategorie: 'Restaurant', btw: '9%', icon: '🍽️', keywords: ['hema restaurant'] },
  ...
  'achmea': { categorie: 'Verzekeringen', subcategorie: 'Verzekering', btw: '21%', icon: '🛡️' },
  'centraal beheer': { categorie: 'Verzekeringen', subcategorie: 'Verzekering', btw: '21%', icon: '🛡️' },
  'interpolis': { categorie: 'Verzekeringen', subcategorie: 'Verzekering', btw: '21%', icon: '🛡️' },
  'aegon': { categorie: 'Verzekeringen', subcategorie: 'Verzekering', btw: '21%', icon: '🛡️' },
  'nationale nederlanden': { categorie: 'Verzekeringen', subcategorie: 'Verzekering', btw: '21%', icon: '🛡️' },
  'nn': { categorie: 'Verzekeringen', subcategorie: 'Verzekering', btw: '21%', icon: '🛡️' },
  'univé': { categorie: 'Verzekeringen', subcategorie: 'Verzekering', btw: '21%', icon: '🛡️' },
  'asr': { categorie: 'Verzekeringen', subcategorie: 'Verzekering', btw: '21%', icon: '🛡️' },
  ...
  // Online Retail
  'bol.com': { categorie: 'Online Winkelen', subcategorie: 'Webshop', btw: '21%', icon: '🛍️' },
  'amazon': { categorie: 'Online Winkelen', subcategorie: 'Webshop', btw: '21%', icon: '🛍️', keywords: ['amazon.nl'] },
  'coolblue': { categorie: 'Online Winkelen', subcategorie: 'Webshop', btw: '21%', icon: '🖥️' },
  'mediamarkt': { categorie: 'Online Winkelen', subcategorie: 'Webshop', btw: '21%', icon: '🖥️' },
  'wehkamp': { categorie: 'Online Winkelen', subcategorie: 'Webshop', btw: '21%', icon: '🛍️' },
  ...
  'action': { categorie: 'Online Winkelen', subcategorie: 'Webshop', btw: '21%', icon: '🛍️' },
  ...
  // Software & Tools
  'google': { categorie: 'Software', subcategorie: 'Cloud', btw: '21%', icon: '☁️', keywords: ['google workspace', 'gsuite'] },
  'microsoft': { categorie: 'Software', subcategorie: 'Cloud', btw: '21%', icon: '☁️', keywords: ['office 365', 'microsoft 365'] },
  'adobe': { categorie: 'Software', subcategorie: 'Creatief', btw: '21%', icon: '🎨', keywords: ['creative cloud'] },
  'dropbox': { categorie: 'Software', subcategorie: 'Cloud', btw: '21%', icon: '☁️' },
  ...
  'belastingdienst': { categorie: 'Belastingen', subcategorie: 'Overheid', btw: '0%', icon: '🏛️' },
  
  // Overheid
  'gemeente': { categorie: 'Overheid', subcategorie: 'Gemeentebelasting', btw: '0%', icon: '🏛️' },
  'waterschap': { categorie: 'Overheid', subcategorie: 'Waterschap', btw: '0%', icon: '🏛️' },
  'provincie': { categorie: 'Overheid', subcategorie: 'Provincie', btw: '0%', icon: '🏛️' },
