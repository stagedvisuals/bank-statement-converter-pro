...
export default function FAQ() {
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Basic (€2/doc) is pay-as-you-go voor incidenteel gebruik. Business (€15/maand) biedt 50 conversies per maand met batch processing en priority support. Enterprise (€30/maand) geeft 2.000 conversies per maand, whitelabel rapporten, JSON export en een persoonlijke onboarding."
    }
  ]
